    ...
    <div className="p-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-8">
        ...
        <div className="flex gap-4 mt-8">
          <button type="submit" disabled={loading} className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all flex items-center gap-2 disabled:opacity-50">
            <Save size={20} />
