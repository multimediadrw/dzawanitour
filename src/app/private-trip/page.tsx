        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-3 flex-shrink-0">
            <div className="text-right">
              <p className="text-xs text-gray-400 font-inter mb-0.5">{pt.startingFrom}</p>
            ...
            <a
                ...
                language === "en"
                  ? `Hello Dzawani Tour, I am interested in the Private Trip *${item.destinasi}* package.\n\nPlease provide more information about schedule and availability.`
            ...
            {paxOptions.map((opt) => (
              ...
              >
                ...
                <a
                   href={`https://wa.me/628112222254?text=${encodeURIComponent(
                    language === "en"
                      ? `Hello Dzawani Tour, I would like to book the Private Trip *${item.destinasi}* for ${opt.label}.\n\nPrice: ${formatRupiah(opt.price)}/pax\n\nPlease provide more information.`
    ...
    <div className="container mx-auto px-4 max-w-7xl py-12">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
        ...
        <div className="p-6 space-y-4">
          {data.map((item) => (
            <PrivateTripCard key={item.id} item={item} pt={pt as unknown as Record<string, string>} language={t.nav.home === "Home" ? "en" : "id"} />
          ))}
        </div>
